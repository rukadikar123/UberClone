    ...
    <div>
      ...
      <div className="flex flex-col gap-1">
        ...
        >
          ...
          <h2 className="text-sm">RS.192</h2>
        </div>
        <div className="flex w-full p-2 mt-2 items-center justify-between border-2 border-gray-100 rounded-md active:border-gray-500 gap-1">
          <img
            className="h-14"
        ...
        <div className="flex w-full p-2 mt-2 items-center justify-between border-2 border-gray-100 rounded-md active:border-gray-500 gap-1">
          ...
          <h2 className="text-sm">RS.112</h2>
        </div>
      </div>
    </div>
  );
